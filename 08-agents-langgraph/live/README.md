...
3. Настройте переменные окружения:
   ```bash
   # Создайте .env файл на основе примера в README
   ```
...
2. Получите бесплатный API ключ (1500 запросов в месяц)
3. Добавьте ключ в переменную `EXCHANGE_RATE_API_KEY`
...
- `EXCHANGE_RATE_API_KEY` - API ключ для конвертации валют (получить на exchangerate-api.com)
- `EXCHANGE_RATE_API_URL` - URL API для конвертации валют (по умолчанию: https://v6.exchangerate-api.com/v6)
