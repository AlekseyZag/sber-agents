...
- 🔄 **ReAct паттерн:**
  ...
  - **Act** - вызывает нужный инструмент (rag_search / search_products / currency_converter / calculate_deposit_profit)
...
- 🛠️ **4 типа инструментов:**
  ...
  - `calculate_deposit_profit` - расчет доходности вклада с капитализацией (MCP)
...
- 🎯 **Умная стратегия:**
  ...
  - Расчет доходности вклада → использует calculate_deposit_profit (MCP)
...
- `calculate_deposit_profit` - расчет доходности вклада с учетом капитализации процентов
